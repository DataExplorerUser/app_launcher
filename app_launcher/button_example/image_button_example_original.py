...
with dpgs.window('main'):
    dpg.add_label_text('##status1', default_value='a', parent='main', before='button1')
    dpg.add_label_text('##status2', default_value='Status image 2: not selected', parent='main', before='button1')
